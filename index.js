...
var api = new ParseServer({
  ...
  serverURL: process.env.SERVER_URL || 'http://pacific-lowlands-64465.herokuapp.com'  // Don't forget to change to https if needed
  publicServerURL: 'http://pacific-lowlands-64465.herokuapp.com'
